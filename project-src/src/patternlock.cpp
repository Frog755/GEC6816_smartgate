...
PatternLock::PatternLock(QWidget *parent)
    ...
    , lineColor_(100, 200, 255, 200)
    , successColor_(100, 255, 180, 220)
    , failColor_(255, 100, 100, 220)
    , dotColor_(80, 80, 120, 180)
    , selectedDotColor_(100, 200, 255, 220)
{
...
{
    painter.fillRect(rect(), QColor(30, 30, 50, 200));
}
