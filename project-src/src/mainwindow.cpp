...
void MainWindow::setupUI()
{
    ...
    parkingCountLabel_->setStyleSheet(
        ...
        "    font-size: 14px; "
        "    font-weight: bold; "
        "    color: rgba(100, 255, 180, 220); "
        "    padding: 6px; "
        "    background-color: rgba(100, 255, 180, 15); "
    ...
    inboundBtn_->setStyleSheet(
        "QPushButton { font-size: 15px; font-weight: bold; background-color: rgba(100, 200, 255, 25); color: rgba(100, 200, 255, 220); border: 1px solid rgba(100, 200, 255, 40); border-radius: 8px; padding: 8px 5px; }"
        "QPushButton:pressed { background-color: rgba(100, 200, 255, 40); }"
        "QPushButton:disabled { background-color: rgba(255, 255, 255, 5); color: rgba(255, 255, 255, 50); border-color: rgba(255, 255, 255, 20); }"
    );
    ...
    viewRecordsBtn_->setStyleSheet(
        "QPushButton { font-size: 13px; font-weight: bold; background-color: rgba(255, 255, 255, 10); color: rgba(255, 255, 255, 180); border: 1px solid rgba(255, 255, 255, 20); border-radius: 6px; padding: 6px 5px; }"
    ...
    lockBtn_->setStyleSheet(
        "QPushButton { font-size: 15px; font-weight: bold; background-color: rgba(233, 69, 96, 25); color: rgba(255, 255, 255, 200); border: 1px solid rgba(233, 69, 96, 40); border-radius: 8px; padding: 8px 5px; }"
...
void MainWindow::showPlateResult(const QString &plate, bool isInbound)
{
    ...
    if (!errorMsg.isEmpty()) {
        ...
        errBox->setStyleSheet(
            "QMessageBox { background-color: rgba(30, 30, 50, 240); border: 1px solid rgba(255, 255, 255, 20); border-radius: 12px; }"
            "QLabel { color: rgba(255, 100, 100, 220); font-size: 16px; }"
            "QPushButton { font-size: 14px; min-width: 80px; padding: 8px; "
            "    background-color: rgba(255, 255, 255, 10); color: rgba(255, 255, 255, 180); border: 1px solid rgba(255, 255, 255, 20); "
            "    border-radius: 8px; }"
        );
    ...
    msgBox->setStyleSheet(
        "QMessageBox { background-color: rgba(30, 30, 50, 240); border: 1px solid rgba(255, 255, 255, 20); border-radius: 12px; }"
        "QLabel { color: rgba(255, 255, 255, 200); font-size: 16px; }"
        "QPushButton { font-size: 14px; min-width: 80px; padding: 8px; "
        "    background-color: rgba(100, 200, 255, 20); color: rgba(100, 200, 255, 220); border: 1px solid rgba(100, 200, 255, 30); "
        "    border-radius: 8px; }"
    );
...
void MainWindow::showBill(const QString &plate, const QString &inTimeStr)
{
    ...
    billBox->setStyleSheet(
        "QMessageBox { background-color: rgba(30, 30, 50, 240); border: 1px solid rgba(255, 255, 255, 20); border-radius: 12px; }"
        "QLabel { color: rgba(100, 200, 255, 220); font-size: 14px; font-family: monospace; }"
        "QPushButton { font-size: 14px; min-width: 80px; padding: 8px; "
        "    background-color: rgba(100, 200, 255, 20); color: rgba(100, 200, 255, 220); border: 1px solid rgba(100, 200, 255, 30); "
        "    border-radius: 8px; }"
    );
...
void MainWindow::onCardDetected(const QString &cardId)
{
    ...
    if (plate.isEmpty()) {
        ...
        rfidStatusLabel_->setStyleSheet(
            ...
            "    padding: 6px; "
            "    background-color: rgba(255, 100, 100, 15); "
...
void MainWindow::showRecentRecords()
{
    ...
    recordBox->setStyleSheet(
        "QMessageBox { background-color: rgba(30, 30, 50, 240); border: 1px solid rgba(255, 255, 255, 20); border-radius: 12px; }"
        "QLabel { color: rgba(255, 255, 255, 200); font-size: 12px; font-family: monospace; }"
        "QPushButton { font-size: 14px; min-width: 80px; padding: 8px; "
        "    background-color: rgba(100, 200, 255, 20); color: rgba(100, 200, 255, 220); border: 1px solid rgba(100, 200, 255, 30); "
        "    border-radius: 8px; }"
    );
